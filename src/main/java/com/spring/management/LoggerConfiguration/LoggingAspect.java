package com.spring.management.LoggerConfiguration;
...
public class LoggingAspect {
    ...
    public void logAfterCreateUser(Object result) {
        logger.info("Successfully created user with ID: {}", ((Admin) result).getId());
    }
    ...
    public void logAfterGetUserById(Object result) {
        if (result != null) {
            logger.info("Successfully fetched user with ID: {}", ((Admin) result).getId());
        } else {
    ...
    public void logAfterUpdateUser(Object result) {
        logger.info("Successfully updated user with ID: {}", ((Admin) result).getId());
    }
